...
class calculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Calculator Mohammed_Amin'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  int _counter = 0; double num1=0,num2=0;String t1='',t2='',result='';
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child:   TextField(decoration: InputDecoration(labelText: 'Enter a number please',
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child:   TextField(decoration: InputDecoration(labelText: 'Enter another number please',
