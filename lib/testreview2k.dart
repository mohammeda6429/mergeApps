...
class testreview2k extends StatelessWidget {
  const testreview2k({super.key});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Mohammed_Amin TestReview3'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Row Test ({w,c,l}){
    return Row(
      children: [
        SizedBox(width: w),
        Container(width: 75, height: 65, color: l, child: Text('MohammedAmin'),),
      ],
    );
  }
